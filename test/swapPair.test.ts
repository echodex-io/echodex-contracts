...
contract("EchodexPair", ([alice, bob, carol, david, erin]) => {
    ...
    describe("Swap qua Pair, qua token fee trung gian, trả fee bằng token fee trong ví user", async () => {
        ...
        it("Swap Pair", async function () {
            ...
            await pairVANVI.swapPayWithTokenFee(parseEther("0"), parseEther("500"), alice, alice, "0x", { from: alice });
