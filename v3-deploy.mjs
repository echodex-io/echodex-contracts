...
await $`yarn workspace @echodex/v3-core run hardhat run scripts/deploy.ts --network ${network}`

await $`yarn workspace @echodex/v3-periphery run hardhat run scripts/deploy2.ts --network ${network}`
