...
describe('EchodexV3Pool', () => {
  ...
  let pool0: MockTimeEchodexV3Pool
  let pool1: MockTimeEchodexV3Pool
  ...
  let swapTargetCallee: TestEchodexV3Callee
  let swapTargetRouter: TestEchodexV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeEchodexV3Pool, any]> => {
