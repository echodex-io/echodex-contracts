...
import { EchodexV3PoolSwapTest } from '../typechain-types/contracts/test/EchodexV3PoolSwapTest'
...
describe('EchodexV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('EchodexV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as EchodexV3PoolSwapTest
          ...
          let tester: EchodexV3PoolSwapTest
