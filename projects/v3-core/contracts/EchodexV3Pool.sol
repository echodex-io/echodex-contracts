...
import './interfaces/IEchodexV3PoolDeployer.sol';
import './interfaces/IEchodexV3Factory.sol';
...
contract EchodexV3Pool is IEchodexV3Pool {
    ...
    /// @inheritdoc IEchodexV3PoolImmutables
    ...
    /// @inheritdoc IEchodexV3PoolState
    ...
    // liquidity mining
    IEchodexV3LmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IEchodexV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IEchodexV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IEchodexV3PoolDerivedState
    ...
    /// @inheritdoc IEchodexV3PoolActions
    ...
    function mint(
        ...
        IEchodexV3MintCallback(msg.sender).echodexV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IEchodexV3SwapCallback(msg.sender).echodexV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IEchodexV3FlashCallback(msg.sender).echodexV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IEchodexV3PoolOwnerActions
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = IEchodexV3LmPool(_lmPool);
