...
| Name | Type | Description |
| ---- | ---- | ----------- |
| deployer | address | The EchodexSwap V3 deployer contract address |
...
```solidity
function getPool(address deployer, address tokenA, address tokenB, uint24 fee) public pure returns (contract IEchodexV3Pool)
```
...
```solidity
function verifyCallback(address deployer, address tokenA, address tokenB, uint24 fee) public view returns (contract IEchodexV3Pool pool)
```

Returns the address of a valid EchodexSwap V3 Pool

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| deployer | address | The contract address of the EchodexSwap V3 deployer |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| pool | contract IEchodexV3Pool | The V3 pool contract address |

### verifyCallback

```solidity
function verifyCallback(address deployer, struct SmartRouterHelper.PoolKey poolKey) public view returns (contract IEchodexV3Pool pool)
```
