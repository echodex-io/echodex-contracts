...
Router for stateless execution of swaps against EchodexSwap V3
...
```solidity
function echodexV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes _data) external
```
