...
import '@echodex/v3-periphery/contracts/base/BlockTimestamp.sol';
import '@echodex/v3-periphery/contracts/libraries/Path.sol';
import '@echodex/v3-periphery/contracts/libraries/PoolAddress.sol';
import '@echodex/v3-core/contracts/interfaces/IEchodexV3Pool.sol';
import '@echodex/v3-periphery/contracts/libraries/OracleLibrary.sol';
...
abstract contract OracleSlippage is IOracleSlippage, PeripheryImmutableState, BlockTimestamp {
    ...
    function getBlockStartingAndCurrentTick(IEchodexV3Pool pool)
        internal
        view
    ...
    function getPoolAddress(
        ...
        address tokenB,
        uint24 fee
    ) internal view virtual returns (IEchodexV3Pool pool) {
        pool = IEchodexV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
        ...
        returns (int256 syntheticAverageTick, int256 syntheticCurrentTick)
    {
        ...
        for (uint256 i = 0; i < numPools; i++) {
            ...
            IEchodexV3Pool pool = getPoolAddress(tokenIn, tokenOut, fee);
            ...
            if (secondsAgo == 0) {
                ...
                (, currentTick, , , , , ) = IEchodexV3Pool(pool).slot0();
            }
