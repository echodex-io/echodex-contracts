...
import '@echodex/v3-periphery/contracts/base/PeripheryImmutableState.sol';
import '@echodex/v3-core/contracts/libraries/SafeCast.sol';
import '@echodex/v3-core/contracts/libraries/TickMath.sol';
import '@echodex/v3-core/contracts/libraries/TickBitmap.sol';
...
import '@echodex/v3-periphery/contracts/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IEchodexV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    /// @inheritdoc IEchodexV3SwapCallback
    function echodexV3SwapCallback(
        ...
        IEchodexV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IEchodexV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
