...
const EchodexStableSwapFactory = artifacts.require("stable-swap/contracts/EchodexStableSwapFactory.sol");
const EchodexStableSwapLPFactory = artifacts.require("stable-swap/contracts/EchodexStableSwapLPFactory.sol");
const EchodexStableSwapTwoPoolDeployer = artifacts.require("stable-swap/contracts/EchodexStableSwapTwoPoolDeployer.sol");
const EchodexStableSwapThreePoolDeployer = artifacts.require("stable-swap/contracts/EchodexStableSwapThreePoolDeployer.sol");
const EchodexStableSwapTwoPool = artifacts.require("stable-swap/contracts/EchodexStableSwapTwoPool.sol");
const EchodexStableSwapThreePool = artifacts.require("stable-swap/contracts/EchodexStableSwapThreePool.sol");
const EchodexStableSwapTwoPoolInfo = artifacts.require("stable-swap/contracts/utils/EchodexStableSwapTwoPoolInfo.sol");
const EchodexStableSwapThreePoolInfo = artifacts.require("stable-swap/contracts/utils/EchodexStableSwapThreePoolInfo.sol");
const EchodexStableSwapInfo = artifacts.require("stable-swap/contracts/utils/EchodexStableSwapInfo.sol");
const LPToken = artifacts.require("stable-swap/contracts/EchodexStableSwapLP.sol");
...
const EchodexFactory = artifacts.require("exchange-protocol/contracts/EchodexFactory.sol");
const EchodexPair = artifacts.require("exchange-protocol/contracts/EchodexPair.sol");
const EchodexRouter = artifacts.require("exchange-protocol/contracts/EchodexRouter.sol");
...
contract("SmartRouter", ([admin, bob, carol]) => {
    ...
    before(async () => {
        ...
        /** Create Stable Swap */
        stableSwapLPFactory = await EchodexStableSwapLPFactory.new({ from: admin });
        stableSwap2PoolDeployer = await EchodexStableSwapTwoPoolDeployer.new({ from: admin });
        stableSwap3PoolDeployer = await EchodexStableSwapThreePoolDeployer.new({ from: admin });
        stableSwapFactory = await EchodexStableSwapFactory.new(stableSwapLPFactory.address, stableSwap2PoolDeployer.address, stableSwap3PoolDeployer.address, {
            from: admin,
        });
        stableSwap2PoolInfo = await EchodexStableSwapTwoPoolInfo.new({ from: admin });
        stableSwap3PoolInfo = await EchodexStableSwapThreePoolInfo.new({ from: admin });
        stableSwapPoolInfo = await EchodexStableSwapInfo.new(stableSwap2PoolInfo.address, stableSwap3PoolInfo.address, { from: admin });
        ...
        stable2Pool_BUSD_USDC = await EchodexStableSwapTwoPool.at(stable2PoolInfo.swapContract);
        ...
        stable2Pool_WBNB_BUSD = await EchodexStableSwapTwoPool.at(stable2PoolInfo_WBNB_BUSD.swapContract);
        ...
        stable3Pool_BUSD_USDC_USDT = await EchodexStableSwapThreePool.at(stable3PoolInfo.swapContract);
