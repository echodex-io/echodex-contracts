...
```solidity
contract IEchodexV3FactoryOwner factoryOwner
```
...
```solidity
constructor(address _masterChef, contract IEchodexV3FactoryOwner _factoryOwner) public
```

### deploy

```solidity
function deploy(contract IEchodexV3Pool pool) external returns (contract IEchodexV3LmPool lmPool)
```
...
| ---- | ---- | ----------- |
| pool | contract IEchodexV3Pool | The contract address of the EchodexSwap V3 pool |
