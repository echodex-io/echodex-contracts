...
contract QuoterV2 is IQuoterV2, IEchodexV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IEchodexV3Pool) {
        return IEchodexV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function echodexV3SwapCallback(
        ...
        IEchodexV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IEchodexV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
