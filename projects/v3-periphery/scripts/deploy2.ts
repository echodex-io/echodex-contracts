...
const artifacts: { [name: string]: ContractJson } = {
  ...
  EchodexInterfaceMulticall: require('../artifacts/contracts/lens/EchodexInterfaceMulticall.sol/EchodexInterfaceMulticall.json'),
...
async function main() {
  ...
  const echodexV3PoolDeployer_address = deployedContracts.EchodexV3PoolDeployer
  ...
  const EchodexInterfaceMulticall = new ContractFactory(
    artifacts.EchodexInterfaceMulticall.abi,
    artifacts.EchodexInterfaceMulticall.bytecode,
    owner
  )

  const echodexInterfaceMulticall = await EchodexInterfaceMulticall.deploy()
  console.log('EchodexInterfaceMulticall', echodexInterfaceMulticall.address)

  // await tryVerify(echodexInterfaceMulticall)
  ...
  const contracts = {
    ...
    EchodexInterfaceMulticall: echodexInterfaceMulticall.address,
  }
