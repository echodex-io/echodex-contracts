...
const WBNB = "0x2C1b868d6596a18e32E61B901E4060C872647b6C"; // LINEA TESTNET
...
async function main() {
  ...
  const echodexV3PoolDeployer_address = '0xbdD522BcaD75E2ab05d183DA5e3944FAa11BF016';
  const echodexV3Factory_address = '0x1fAfB866CF6fA0DE860a43b2bF025BcF6aE29a74';

  const SwapRouter = new ContractFactory(artifacts.SwapRouter.abi, artifacts.SwapRouter.bytecode, owner);
  const swapRouter = await SwapRouter.deploy(echodexV3PoolDeployer_address, echodexV3Factory_address, WBNB);
