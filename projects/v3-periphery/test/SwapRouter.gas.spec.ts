import { abi as IEchodexV3PoolABI } from '@echodex/v3-core/artifacts/contracts/interfaces/IEchodexV3Pool.sol/IEchodexV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IEchodexV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain-types'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IEchodexV3Pool, IEchodexV3Pool, IEchodexV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IEchodexV3PoolABI, wallet)) as [
      IEchodexV3Pool,
      IEchodexV3Pool,
      IEchodexV3Pool
    ]
  ...
  let pools: [IEchodexV3Pool, IEchodexV3Pool, IEchodexV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it.skip('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestEchodexV3Callee')
