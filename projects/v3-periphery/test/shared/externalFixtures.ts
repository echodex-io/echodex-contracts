...
} from '@echodex/v3-core/artifacts/contracts/EchodexV3PoolDeployer.sol/EchodexV3PoolDeployer.json'
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@uniswap/v2-core/build/UniswapV2Factory.json'
import { Fixture } from 'ethereum-waffle'
import { ethers, waffle } from 'hardhat'
import { IEchodexV3Factory, IWETH9, MockTimeSwapRouter } from '../../typechain-types'
...
const v3CoreFactoryFixture: Fixture<{ deployer: Contract; factory: IEchodexV3Factory }> = async ([wallet]) => {
